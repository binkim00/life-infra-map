...
def aggregate_tag_evidence(place, tag, *, now=None, dry_run=False):
    ...
    elif admin_positive_count > admin_negative_count and web_positive_count >= 1 and web_net > 0:
        result.update(confirmed_source="checked", status="confirmed", confidence=90)
    elif user_positive_count > user_negative_count and web_positive_count >= 3 and web_net > 0:
