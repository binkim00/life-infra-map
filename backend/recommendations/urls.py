...
urlpatterns = [
    ...
    path("conversation-sessions/", views.conversation_session_create),
    path("conversation-sessions/<uuid:session_id>/", views.conversation_session_detail),
    path("conversation-sessions/<uuid:session_id>/turns/", views.conversation_session_turn),
