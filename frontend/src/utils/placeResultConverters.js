...
export const convertRecommendationPlaces = (
  ...
  return toArray(places).map((place) => {
    ...
    return mergeRequestedConditionReview({
      ...
      evidenceGaps: toDisplayList(place.evidence_gaps),
      evidenceQualityLevel: getTextValue(place.evidence_quality_level),
      evidenceQualityScore: Number(place.evidence_quality_score || 0),
